package za.co.tman.systemgw.repository;

import za.co.tman.systemgw.SystemgatewayApp;
import za.co.tman.systemgw.config.Constants;
import za.co.tman.systemgw.config.audit.AuditEventConverter;
import za.co.tman.systemgw.domain.PersistentAuditEvent;
...
import static za.co.tman.systemgw.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
